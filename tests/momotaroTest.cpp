...
TEST(MomotaroTest, constructorTest) {
    Momotaro *testCharacter = new Momotaro("Momotaro", 20, 10, 5);
...
TEST(CharacterTest, callConstructor) {
    EXPECT_NO_THROW(Momotaro *testCharacter = new Momotaro("Momotaro", 20, 10, 5));
}

TEST(CharacterTest, callConstructor2) {
    EXPECT_NO_THROW(Momotaro *testCharacter = new Momotaro());
}
